...
=======
>>>>>>> ad8bb74008067c85e34c0467d4ccf67bc4abc508
class SpinalMain {
    constructor() {
...
<<<<<<< HEAD
    ...
    ///////////////////////////////////////////////////
    async calculateAnalyticsGlobalEnergy(controlBmsEndpointId, elementId, typeOfElement) {
        let endpointList = [];
    ...
    async calculateAnalyticsGlobalCVC(controlBmsEndpointId, elementId, typeOfElement) {
        let endpointList = [];
        if (typeOfElement == "geographicBuilding") {
            let filter = "CVC";
            endpointList = await spinal_env_viewer_graph_service_1.SpinalGraphService.getChildren(elementId, ["hasEndPoint"]);
